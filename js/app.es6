...
require(['react', 'react-bootstrap', 'react-router', 'ramda', 'moment', 'jquery', 'shuttle', 'shuttle-react', 'large-local-storage'], (React, ReactBootstrap, ReactRouter, R, moment, $, Shuttle, ShuttleReact, LargeLocalStorage) => {
