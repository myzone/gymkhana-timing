...
define(['react', 'react-bootstrap'], function (React, ReactBootstrap) {
    ...
    return React.createClass({
        render: function render() {
            ...
            var results = DOM.div({}, [DOM.table({ style: { width: '100%' } }, DOM.tr({}, [DOM.td({ style: { width: '250px' } }), DOM.td({}, [React.createElement('center', {}, DOM.div({ style: { marginTop: '20px' } }, [DOM.span({ className: 'race-number' }, "42"), ' ', DOM.span({}, "Vyacheslav Goldenshteyn")])), DOM.div({
                style: {
                    background: 'silver',
                    height: '60px',
                    marginLeft: '5px',
            ...
            var content = DOM.div({}, [React.createElement(ReactBootstrap.PageHeader, {}, "Championship of Ukraine 2015"), React.createElement(ReactBootstrap.Pager, {}, [React.createElement(ReactBootstrap.PageItem, { previous: true }, [React.createElement(ReactBootstrap.Glyphicon, { glyph: 'menu-left' }), ' ', "Configuration"]), React.createElement(ReactBootstrap.PageItem, { href: "" }, "Registration"), React.createElement(ReactBootstrap.PageItem, {}, "Competition"), React.createElement(ReactBootstrap.PageItem, { next: true, disabled: true }, ["Results", ' ', React.createElement(ReactBootstrap.Glyphicon, { glyph: 'menu-right' })])]), DOM.h1({}, "registration"), DOM.div({}, registration), DOM.h1({}, "competition"), DOM.div({}, competition), DOM.h1({}, "results"), DOM.div({}, results)]);
